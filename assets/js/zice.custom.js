...
$(document).ready(function(){	
  ...
  //DataTable
    ...
    $('#dataTable1').dataTable( {
	  ...
	  "sDom": "<'row-fluid tb-head'<'span4'f><'span2'<'pull-right'T>>rl>t<'row-fluid tb-foot'<'span4'i><'span8'p>>",
	  "bJQueryUI": false,
	  "aaSorting": [],
	  "iDisplayLength": 10,
	  "sPaginationType": "bootstrap",
...
$(function() {		
   ...
   $('#timepicker').timepicker({});
	...
	// Maskedinput 
        $.mask.definitions['~'] = "[+-]";
        $("#date").mask("9999/99/99",{completed:function(){ alert("completed!");}});
		$("#dateMasked").mask("99/99/9999",{completed:function(){ alert("completed!");}});
		$("#entrada").datepicker().mask("9999-99-99");
		$("#salida").datepicker().mask("9999-99-99");
		$("#fventa").datepicker().mask("9999-99-99");
 ...
 function Processgraph(){
	...
	$(".Delete").live('click',function() { 
		...
		'message': "<strong> ESTAS SEGURO DE ELIMINAR </strong><br /><font color=red>' "+ name +" ' </font> ",
		'buttons': {
			   'Yes': { 
			   			'class': 'special',
						'action': function(){
